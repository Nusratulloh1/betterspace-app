  ...
  <div>
    <div class="dropdown-container z-50">
      <div class="dropdown-trigger" @click="toggleDropdown">
        ...
        <svg width="9" height="4" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
      ...
      <transition name="fade">
        <div v-if="isOpen" class="dropdown-options">
          <div v-for="option in options" :key="option.key" @click="handleSelect(option.key)"
